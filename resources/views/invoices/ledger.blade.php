...
<body>
    ...
    <div class="invoice-container">
        ...
        <table class="details">
            @php
                $trn_no = date('ymdHis'); // e.g. 251030142530 → YYMMDDHHMMSS
            @endphp
            <tr>
            ...
            <tr>
                ...
                <td colspan="3">
                    {{ $customer->id }}-{{ strtoupper($customer->company_name ?? $customer->first_name . ' ' . $customer->last_name) }}
                </td>
            </tr>
            <tr>
                <td class="label">VEHICLE NUMBER:</td>
                <td colspan="3">{{ $customer->vehicle ? $customer->vehicle->vehicle_number : '' }}</td>
            </tr>
            <tr>
                <td class="label">DRIVER NAME:</td>
                <td colspan="3">{{ $customer->driver ? $customer->driver->name : '' }}</td>
            </tr>
            <tr>
