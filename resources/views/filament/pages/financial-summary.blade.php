    ...
    {{-- <div class="mt-6">
        <div class="flex justify-end mb-4">
            <button 
                ...
                type="button"
                class="inline-flex items-center px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-lg shadow-md transition duration-150 ease-in-out">
            ...
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                <div class="text-center">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Click "Generate Report" to view financial summary for the selected period.
                    </p>
                </div>
            </div>
        </div>
